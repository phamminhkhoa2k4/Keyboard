...
$username = $_SESSION['add-chech-data']['username'] ?? null;
$phone = $_SESSION['add-chech-data']['phone'] ?? null;
$email = $_SESSION['add-chech-data']['email'] ?? null;
$address = $_SESSION['add-chech-data']['address'] ?? null;


unset($_SESSION['add-chech-data']);
?>
<style>
    .checkout-wrapper {
        display: grid;
