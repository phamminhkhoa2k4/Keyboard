    ...
    <div class="container product_detail_container">
        ...
        <div class="detail_information_container">
            <div class="detail_information_wrapper">
                ...
                <form action="<?= ROOT_URL ?>admin/cart.php" class="detail_form_cart" method="POST">
                    <input type="hidden" name="product_id" value="<?= $product['id'] ?>">
                    <div class="detail_form_cart_wrapper">
                        <div class="button_add_quality">
                            <input type="button" value='-' class="minus_quality">
                            <input type="number" name="product_qty" class="quality_text" min='1' value="1" step="1" style="border:1px solid rgb(0,0,0,.2);">
                        ...
                        <input type="hidden" name="images_no1" value="./images/<?= $product['images_no1'] ?>">
