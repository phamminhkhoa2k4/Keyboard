...
if (isset($_POST['submit'])) {
    ...
    if (!$images_no1) {
        ...
        $_SESSION['add-product'] = " please enter your KeyCap Material";
            ...
            $avatar_destination_path1 = '../images/' . $avatar_name;
            $avatar_destination_path2 = '../images/' . $avatar_name;
            $avatar_destination_path3 = '../images/' . $avatar_name;
            $avatar_destination_path4 = '../images/' . $avatar_name;
            $avatar_destination_path5 = '../images/' . $avatar_name;
    ...
    if(isset($_SESSION['add-product'])){
        ...
        $query = "INSERT INTO products (images_no1,brand,name,price,images_no2,images_no3,images_no4,images_no5,description_title,description,guarantee,type,cable,switch,size,connection,color,led_color,keycap_material) VALUES ('$avatar_name1','$brand','$name','$price','$avatar_name2','$avatar_name3','$avatar_name4','$avatar_name5','$description_title','$description','$guarantee','$type','$cable','$switch','$size','$connect_type','$color','$led_color','$keycap_material')";
