            ...
            <main>
                <?php if (mysqli_num_rows($products)) : ?>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php while($products = mysqli_fetch_assoc($products)) : ?>
                                <tr>
                                    <td>
                                        <img src="<?= ROOT_URL . 'images/' . $products['images_no1'] ?>g" alt="">
                                    </td>
                                    <td><?= $products['brand'] ?></td>
                                    <td><?= $products['name'] ?></td>
                                    <td><?= $products['price'] ?></td>
                                    <td><a href="<?= ROOT_URL ?>admin/edit-product.php?id=<?= $products['id'] ?>" class="sm">Edit</a></td>
                                    <td><a href="<?= ROOT_URL ?>admin/delete-product.php?id=<?= $products['id'] ?>" class="danger">Delete</a></td>
                                </tr>
                            <?php endwhile ?>
                        </tbody>
                    </table>
