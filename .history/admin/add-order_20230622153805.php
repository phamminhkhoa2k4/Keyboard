...
<section class="form_section">
    <div class="container form_section_container">
        ...
        <form action="<?= ROOT_URL ?>admin/add-order-logic.php" enctype="multipart/form-data" method="POST">
            <input type="text" name="firstname" value="<?= $firstname ?>" placeholder="Product Name 1" />
            ...
            <input type="text" name="firstname" value="<?= $firstname ?>" placeholder="Product Name 2" />
            <input type="text" name="firstname" value="<?= $firstname ?>" placeholder="Price" />
            <input type="text" name="firstname" value="<?= $firstname ?>" placeholder="Quantity" />
            <input type="text" name="firstname" value="<?= $firstname ?>" placeholder="Product Name 3" />
            <input type="text" name="firstname" value="<?= $firstname ?>" placeholder="Price" />
            <input type="text" name="firstname" value="<?= $firstname ?>" placeholder="Quantity" />
