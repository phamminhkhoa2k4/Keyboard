...
$query = "SELECT order.username,order.username order_details.name  , order_details.brand,order_details.price,order_details.quantity
FROM order 
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php while ($order = mysqli_fetch_assoc($orders)) : ?>
                                <tr>
                                    <td><?= $order['product_no1'] ?></td>
                                    <td><?= $order['price1'] ?></td>
                                    <td><?= $order['quantity1'] ?></td>
                                    <td><?= $order['product_no2'] ?></td>
                                    <td><?= $order['price2'] ?></td>
                                    <td><?= $order['quantity2'] ?></td>
                                    <td><?= $order['product_no3'] ?></td>
                                    <td><?= $order['price3'] ?></td>
                                    <td><?= $order['quantity3'] ?></td>
                                    <td><?= $order['total'] ?></td>
                                    <td><a href="<?= ROOT_URL ?>admin/edit-order.php?id=<?= $order['id'] ?>" class="sm">Edit</a></td>
                                    <td><a href="<?= ROOT_URL ?>admin/delete-order.php?id=<?= $order['id'] ?>" class="danger">Delete</a></td>
                                </tr>
                            <?php endwhile ?>
                        </tbody>
                    </table>
