...
<section class="form_section">
    <div class="container form_section_container">
        <h2>Edit Brand</h2>
        <form action="<?= ROOT_URL ?>admin/edit-brand-logic" enctype="multipart/form-data" method="POST">
            ...
            <textarea rows="10" name="description" value="<?= $brand['brand'] ?>" placeholder="Description"></textarea>
