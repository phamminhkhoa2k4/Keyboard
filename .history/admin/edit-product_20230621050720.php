    ...
    <div class="container form_section_container">
        ...
        <form action="signup-logic.php" enctype="multipart/form-data" method="POST">
            ...
            <div class="form_control">
                ...
                <input type="file" value="<?= $products['images_no4'] ?>" name="image_no4" id=" " />
            </div>
            <div class="form_control">
                <label for="">Image Product No 5</label>
                <input type="file" value="<?= $products['images_no5'] ?>" name="image_no5" id=" " />
            </div>
            <input type="text" value="<?= $products['images_no'] ?>" placeholder="Description Title" />
