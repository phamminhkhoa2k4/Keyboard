...
if (isset($_POST['submit'])) {
    ...
    if ($_SESSION['add-order']) {
        ...
        $inset_order_query = "INSERT INTO users SET product_no1='$product_no1',price1='$price',quantity1='$quantity1',product_no2='$product_no1',price1='$price',quantity1='$quantity1', product_no1='$product_no1',price1='$price',quantity1='$quantity1',total='$total', username='$username' , phone='$phone' , email='$email', address = '$address'";
