...
if (isset($_POST['submit'])) {
    ...
    if (!$images_no1) {
        $_SESSION['edit-product'] = " please choose your Image No 1";
    } elseif (!$brand) {
        ...
        $_SESSION['edit-product'] = " please choose your Image No 2";
    } elseif (!$images_no3) {
        $_SESSION['edit-product'] = "please choose your Image No 3";
    } elseif (!$images_no4) {
        $_SESSION['edit-product'] = "please choose your Image No 4";
    } elseif (!$images_no5) {
        $_SESSION['edit-product'] = "please choose your Image No 5";
    } elseif (!$description_title) {
