...
if (isset($_GET['id'])) {
    ...
    $delete_user_query = "DELETE FROM products WHERE id=$id";
    $delete_user_result = mysqli_query($connection, $delete_user_query);
    if (mysqli_errno($connection)) {
        $_SESSION['delete-product'] = "Couldn't delete {$product['name']}";
    } else {
        $_SESSION['delete-product-success'] = "{$product['name']} delete successfully ";
    }
}
