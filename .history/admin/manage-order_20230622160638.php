        ...
        <div class="container dashboard_container">
            <aside>
                <ul>
                    ...
                    <li>
                        <a href="<?= ROOT_URL ?>admin/manage-order.php">
                            <h5>Manage Order</h5>
                        </a>
                    </li>
                </ul>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php while ($order = mysqli_fetch_assoc($orders)) : ?>
                                <tr>
                                    <td><?= $brand['product_no1'] ?></td>
                                    <td><?= $brand['price1'] ?></td>
                                    <td><?= $brand['quantity1'] ?></td>
                                    <td><?= $brand['product_no2'] ?></td>
                                    <td><?= $brand['price2'] ?></td>
                                    <td><?= $brand['quantity2'] ?></td>
                                    <td><?= $brand['product_no3'] ?></td>
                                    <td><?= $brand['price3'] ?></td>
                                    <td><?= $brand['quantity3'] ?></td>
