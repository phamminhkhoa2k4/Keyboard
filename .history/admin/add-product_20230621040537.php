...
<section class="form_section">
    <div class="container form_section_container">
        ...
        <form action="<?= ROOT_URL ?>admin/add-product-logic.php" enctype="multipart/form-data" method="POST">
            ...
            <input type="text" name="name" value="<?= $brand ?>" placeholder="Name" />
            <input type="number" name="price" value="<?= $brand ?>" placeholder="Price">
            <div class="form_control">
            ...
            <input type="text" name="description_title" value="<?= $brand ?>" placeholder="Description Title" />
