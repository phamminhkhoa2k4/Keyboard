...
<section class="form_section">
    <div class="container form_section_container">
        ...
        <form action="<?= ROOT_URL ?>admin/add-order-logic.php" enctype="multipart/form-data" method="POST">
            ...
            <input type="number" name="price1" value="<?= $price1 ?>" placeholder="Price" onchange="calculateTotal()" />
            <input type="number" name="quantity1" value="<?= $quantity3 ?>" placeholder="Quantity" onchange="calculateTotal()" />
            <input type="text" name="product-no2" value="<?= $product_no2 ?>" placeholder="Product Name 2" onchange="toggleProduct2()" />
            <input type="number" name="price2" value="<?= $price2 ?>" placeholder="Price" onchange="calculateTotal()" id="price2" />
