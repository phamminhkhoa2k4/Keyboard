...
if (isset($_POST['submit'])) {
    ...
    if ($_SESSION['add-order']) {
        ...
        $inset_user_query = "INSERT INTO users SET product_no1='$product_no1',price1='$price',quantity1='$quantity1',product_no1='$product_no1',price1='$price',quantity1='$quantity1', product_no1='$product_no1',price1='$price',quantity1='$quantity1',total='$total', username='$username' , phone='$phone' ";
