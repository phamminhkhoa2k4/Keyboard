...
$description = $_SESSION['add-product-data'][''] ?? null;
$guarantee = $_SESSION['add-product-data'][''] ?? null;
$type = $_SESSION['add-product-data'][''] ?? null;
$cable = $_SESSION['add-product-data'][''] ?? null;
$switch = $_SESSION['add-product-data'][''] ?? null;
$size = $_SESSION['add-product-data'][''] ?? null;
$connect_type = $_SESSION['add-product-data'][''] ?? null;
$color = $_SESSION['add-product-data'][''] ?? null;
$led_color = $_SESSION['add-product-data'][''] ?? null;
$keycap_material = $_SESSION['add-product-data'][''] ?? null;
