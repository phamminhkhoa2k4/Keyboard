...
$product_no1 = $_SESSION['add-order-data']['product-no3'] ?? null;
...
<section class="form_section">
    <div class="container form_section_container">
        ...
        <form action="<?= ROOT_URL ?>admin/add-order-logic.php" enctype="multipart/form-data" method="POST">
            ...
            <input type="number" name="price1" value="<?= $firstname ?>" placeholder="Price" />
            <input type="number" name="quantity1" value="<?= $firstname ?>" placeholder="Quantity" />
            <input type="text" name="product-no2" value="<?= $product_no1 ?>" placeholder="Product Name 2" />
            <input type="number" name="price2" value="<?= $firstname ?>" placeholder="Price" />
            <input type="numb" name="quantity2" value="<?= $firstname ?>" placeholder="Quantity" />
            <input type="text" name="product-no3" value="<?= $product_no1 ?>" placeholder="Product Name 3" />
