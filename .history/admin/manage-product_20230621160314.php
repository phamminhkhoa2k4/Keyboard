...
$current_admin_id = $_SESSION['product-id'];

$query = "SELECT * FROM  products WHERE NOT id=$current_admin_id";
...
<?php if (isset($_SESSION['user_is_admin'])) : ?>
    <section class="dashboard">
        <?php if (isset($_SESSION['add-product-success'])) :   ?>
        ...
        <?php elseif (isset($_SESSION['delete-product-success'])) :   ?>
            <div class="alert_message success container">
                <p>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php while ($product = mysqli_fetch_assoc($products)) : ?>
                                <tr>
                                    <td>
                                        <img src="<?= ROOT_URL . 'images/' . $product['images_no1'] ?>" alt="">
                                    </td>
                                    <td><?= $product['brand'] ?></td>
                                    <td><?= $product['name'] ?></td>
                                    <td><?= $product['price'] ?></td>
