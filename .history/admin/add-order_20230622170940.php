...
<section class="form_section">
    <div class="container form_section_container">
        ...
        <form action="<?= ROOT_URL ?>admin/add-order-logic.php" enctype="multipart/form-data" method="POST">
            ...
            <input type="number" name="total" value="<?= $total ?>" placeholder="Total" readonly />
            <input type="text" name="username" value="<?= $username ?>" placeholder="Total" />
            <input type="text" name="phone" value="<?= $phone ?>" placeholder="Total" />
            <input type="text" name="email" value="<?= $total ?>" placeholder="Total" />
