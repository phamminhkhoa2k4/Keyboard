...
if (isset($_POST['submit'])) {
    ...
    if (!$images_no1) {
        ...
        $query = "UPDATE products SET images_no1='$images_no1',brand='$brand',name='$name',price=,images_no2='',images_no3='',images_no4='',images_no5='',description_title='',description='',guarantee='',type='',cable='',switch='',size='',connection='',color='',led_color='',keycap_material=''";

        '','','','$price','$images_no2','$images_no3','$images_no4','$images_no5','$description_title','$description','$guarantee','$type','$cable','$switch','$size','$connect_type','$color','$led_color','$keycap_material'
    }
