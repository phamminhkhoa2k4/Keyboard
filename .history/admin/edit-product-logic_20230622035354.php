...
if (isset($_POST['submit'])) {
    ...
    if (!$brand) {
        ...
        $stmt = mysqli_prepare($connection, $query);
        mysqli_stmt_bind_param($stmt, "sssisssssssssssssssi",  $brand, $name, $price, $description_title, $description, $guarantee, $type, $cable, $switch, $size, $connect_type, $color, $led_color, $keycap_material, $id);
        mysqli_stmt_execute($stmt);
