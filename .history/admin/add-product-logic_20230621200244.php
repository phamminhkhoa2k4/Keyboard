...
if (isset($_POST['submit'])) {
    ...
    if (!$images_no1) {
        ...
        $_SESSION['add-product'] = " please enter your KeyCap Material";
            ...
            $time = time();
            $avatar_name1 = $time . $images_no2['name'];
            $avatar_name2 = $time . $images_no1['name'];
            $avatar_name3 = $time . $images_no1['name'];
            $avatar_name4 = $time . $images_no1['name'];
