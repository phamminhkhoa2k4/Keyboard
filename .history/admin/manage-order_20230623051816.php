                        ...
                        <tbody>
                            <?php while ($order = mysqli_fetch_assoc($orders)) : ?>
                                <tr>
                                    ...
                                    <td><?= $order['address'] ?></td>
                                    <td><?= $order['total'] ?></td>
                                    <td><a href="<?= ROOT_URL ?>admin/edit-order.php?order-id=<?= $order['order_id'] ?>" class="sm">Edit</a></td>
                                    <td><a href="<?= ROOT_URL ?>admin/delete-order.php?order-id=<?= $order['order-id'] ?>" class="danger">Delete</a></td>
                                </tr>
                            <?php endwhile ?>
                        </tbody>
                    </table>
