        ...
        <div class="container dashboard_container">
            <aside>
                <ul>
                    ...
                    <li><a href="<?= ROOT_URL ?>admin/manage-brand.php" style="background: rgb(41, 41, 41);">
                            <h5>Manage Brand</h5>
                        </a></li>
                </ul>
            </aside>
                        ...
                        <tbody>
                            <?php while ($brand = mysqli_fetch_assoc($brands)) : ?>
                                <tr>
                                    ...
                                    <td><a href="<?= ROOT_URL ?>admin/edit-brand.php?id=<?= $product['id'] ?>" class="sm">Edit</a></td>
                                    <td><a href="<?= ROOT_URL ?>admin/edit-delete.php?id=<?= $product['id'] ?>" class="danger">Delete</a></td>
                                </tr>
                            <?php endwhile ?>
