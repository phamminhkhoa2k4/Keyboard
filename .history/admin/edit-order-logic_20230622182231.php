...
if (isset($_POST['submit'])) {
    ...
    if (!$product_no1) {
        ...
        $query = "UPDATE order_product SET product_no1= ? ,price1= ? ,quantity1= ? ,product_no2= ? ,price2= ?,quantity2= ?, product_no3= ?,price3= ?,quantity3= ? ,total=?, username= ? , phone= ? , email= ?, address =  ?  WHERE id = ? LiMIT";
