...
//     die();
if (isset($_POST['submit'])) {
    $images_no1 =isset($_FILES['image_no1']) ? $_FILES['image_no1']['name'] : null;
    $brand = filter_var($_POST['brand'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $name = filter_var($_POST['name'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $price = filter_var($_POST['price'], FILTER_SANITIZE_NUMBER_INT);
    ...
    if (!$brand) {
        ...
        mysqli_stmt_bind_param($stmt, "sssisssssssssssssssi", $images_no1, $brand, $name, $price, $images_no2, $images_no3, $images_no4, $images_no5, $description_title, $description, $guarantee, $type, $cable, $switch, $size, $connect_type, $color, $led_color, $keycap_material, $id);
