...
if (isset($_POST['submit'])) {
    ...
    if (!$brand) {
        ...
        mysqli_stmt_bind_param($stmt, "sssisssssssssssssssi", $avatar_name1, $brand, $name, $price, $images_no2, $images_no3, $images_no4, $images_no5, $description_title, $description, $guarantee, $type, $cable, $switch, $size, $connect_type, $color, $led_color, $keycap_material, $id);
