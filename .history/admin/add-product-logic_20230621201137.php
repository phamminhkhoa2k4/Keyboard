...
if (isset($_POST['submit'])) {
    ...
    if (!$images_no1) {
        ...
        $_SESSION['add-product'] = " please enter your KeyCap Material";
            ...
            $extension = explode('.', $avatar_name1);
            $extension = explode('.', $avatar_name2);
            $extension = explode('.', $avatar_name3);
            $extension = explode('.', $avatar_name4);
            $extension = explode('.', $avatar_name5);
