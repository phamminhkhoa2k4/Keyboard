...
if (isset($_POST['submit'])) {
    $product_no1 = filter_var($_POST['firstname'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $price1 = filter_var($_POST['userrole'], FILTER_SANITIZE_NUMBER_INT);
    $quantity1 = filter_var($_POST['userrole'], FILTER_SANITIZE_NUMBER_INT);
    $product_no2 = filter_var($_POST['firstname'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $price2 = filter_var($_POST['userrole'], FILTER_SANITIZE_NUMBER_INT);
    $quantity2 = filter_var($_POST['userrole'], FILTER_SANITIZE_NUMBER_INT);
    $product_no3 = filter_var($_POST['firstname'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $price3 = filter_var($_POST['userrole'], FILTER_SANITIZE_NUMBER_INT);
    $quantity1 = filter_var($_POST['userrole'], FILTER_SANITIZE_NUMBER_INT);
