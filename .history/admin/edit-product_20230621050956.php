...
<section class="form_section">
    <div class="container form_section_container">
        ...
        <form action="signup-logic.php" enctype="multipart/form-data" method="POST">
            ...
            <input type="text" value="<?= $products['description_type'] ?>" placeholder="Description Title" />
            <textarea rows="5" placeholder="Description"></textarea>
            <input type="text" name="guarantee" value="<?= $products['description'] ?>" placeholder="guarantee" />
            ...
            <input type="text" name="connect_type" value="<?= $products['i'] ?>" placeholder="Connection Type" />
