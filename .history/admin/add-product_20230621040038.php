...
$brand = $_SESSION['add-product-data']['firstname'] ?? null;
$name = $_SESSION['add-product-data']['lastname'] ?? null;
$price = $_SESSION['add-product-data']['username'] ?? null;
$description_title = $_SESSION['add-product-data']['username'] ?? null;
$description = $_SESSION['add-product-data']['username'] ?? null;
$guarantee = $_SESSION['add-product-data']['username'] ?? null;
$type = $_SESSION['add-product-data']['username'] ?? null;
$cable = $_SESSION['add-product-data']['username'] ?? null;
$switch = $_SESSION['add-product-data']['username'] ?? null;
$size = $_SESSION['add-product-data']['username'] ?? null;
$connect_type = $_SESSION['add-product-data']['username'] ?? null;
$color = $_SESSION['add-product-data']['username'] ?? null;
$led_color = $_SESSION['add-product-data']['username'] ?? null;
$keycap_material = $_SESSION['add-product-data']['username'] ?? null;
