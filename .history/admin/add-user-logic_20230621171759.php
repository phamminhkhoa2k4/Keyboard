...
if (isset($_POST['submit'])) {
    ...
    if ($_SESSION['add-user']) {
        ...
        $inset_user_query = "INSERT INTO brand SET brand='$brand',description='$description',thumbnail='$thumbnail'";

        $inset_user_result = mysqli_query($connection, $inset_user_query);

        if (!mysqli_error($connection)) {
            $_SESSION['add-user-success'] = "New Brand $firstname $lastname added successfully .";
