...
<section class="form_section">
    <div class="container form_section_container">
        ...
        <form action="<?= ROOT_URL ?>admin/edit-product-logic.php" enctype="multipart/form-data" method="POST">
            ...
            <input type="text" value="<?= $products['description_title'] ?>" placeholder="Description Title" />
            <textarea rows="5" value="<?= $products['description_type'] ?>" placeholder="Description"></textarea>
