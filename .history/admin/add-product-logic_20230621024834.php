...
if (isset($_POST['submit'])) {
    ...
    if (!$images_no1) {
        $_SESSION['add-'] = " please choose your Image No 1";
    } elseif (!$brand) {
        $_SESSION['add-'] = " please enter your Last Name";
    } elseif (!$name) {
        $_SESSION['add-'] = " please enter your Username ";
    } elseif (!$price) {
        $_SESSION['add-'] = " please enter your Last Name";
    } elseif (!$images_no2) {
        $_SESSION['add-'] = " please choose your Image No 2";
    } elseif (!$images_no3) {
        $_SESSION['add-'] = "please choose your Image No 3";
    } elseif (!$images_no4) {
        $_SESSION['add-'] = "please choose your Image No 4";
    } elseif (!$images_no5) {
        $_SESSION['add-'] = "please choose your Image No 5";
    } elseif (!$description_title) {
        $_SESSION['add-'] = " please enter your Description Title";
    } elseif (!$description) {
        $_SESSION['add-'] = " please enter your Description";
    } elseif (!$guaranteee) {
        $_SESSION['add-'] = " please enter your Guarantee";
    } elseif (!$type) {
        $_SESSION['add-'] = " please enter your Type";
    } elseif (!$cable) {
        $_SESSION['add-'] = " please enter your Cable";
    } elseif (!$switch) {
        $_SESSION['add-'] = " please enter your Switch Type";
    } elseif (!$size) {
        $_SESSION['add-'] = " please enter your Size";
    } elseif (!$connect_type) {
        $_SESSION['add-'] = " please enter your Connection Type";
    } elseif (!$color) {
        $_SESSION['add-'] = " please enter your Color";
    } elseif (!$led_color) {
        $_SESSION['add-'] = " please enter your Led Color";
    } elseif (!$keycap_material) {
        $_SESSION['add-'] = " please enter your KeyCap Material";
    }
}