...
if (isset($_POST['submit'])) {
    ...
    $username  = filter_var($_POST['total'], FILTER_SANITIZE_NUMBER_INT);
    $phone  = filter_var($_POST['total'], FILTER_SANITIZE_NUMBER_INT);
    $email = filter_var($_POST['total'], FILTER_SANITIZE_NUMBER_INT);
    $address = filter_var($_POST['total'], FILTER_SANITIZE_NUMBER_INT);
