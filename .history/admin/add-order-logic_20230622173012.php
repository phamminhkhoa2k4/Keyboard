...
if (isset($_POST['submit'])) {
    ...
    if ($_SESSION['add-order']) {
        ...
        $inset_user_query = "INSERT INTO users SET product_no1='',='$lastname',username='$username',email='$email',password='$hashed_password',avatar='$avatar_name',is_admin=$is_admin";
