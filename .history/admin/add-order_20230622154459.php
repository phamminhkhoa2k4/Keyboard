...
$product_no1 = $_SESSION['add-user-data']['product-no1'] ?? null;
$price1 = $_SESSION['add-user-data']['price1'] ?? null;
$quantity1 = $_SESSION['add-user-data']['quantity1'] ?? null;
$product_no2 = $_SESSION['add-user-data']['product-no1'] ?? null;
$price2 = $_SESSION['add-user-data']['price1'] ?? null;
$quantity2 = $_SESSION['add-user-data']['quantity1'] ?? null;
$product_no1 = $_SESSION['add-user-data']['product-no1'] ?? null;
$price1 = $_SESSION['add-user-data']['price1'] ?? null;
$quantity3 = $_SESSION['add-user-data']['quantity1'] ?? null;
$total = $_SESSION['add-user-data']['email'] ?? null;
