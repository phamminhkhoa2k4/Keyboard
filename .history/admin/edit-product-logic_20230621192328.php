...
if (isset($_POST['submit'])) {
    ...
    if (!$brand) {
        ...
        mysqli_stmt_bind_param($stmt, "sssissssssssssssss", $images_no1, $brand, $name, $price, $images_no2, $images_no3, $images_no4, $images_no5, $description_title, $description, $guarantee, $type, $cable, $switch, $size, $connect_type, $color, $led_color, $keycap_material, $id);
