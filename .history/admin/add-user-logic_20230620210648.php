...
if (isset($_POST['submit'])) {
    ...
    if (!$firstname) {
        $_SESSION[''] = " please enter your First Name";
    } elseif (!$lastname) {
        $_SESSION[''] = " please enter your Last Name";
    } elseif (!$username) {
        $_SESSION[''] = " please enter your Username ";
    } elseif (!$email) {
        $_SESSION[''] = " please enter your a valid Email ";
    } elseif (strlen($createpassword) < 8 || strlen($confirmpassword) < 8) {
        $_SESSION[''] = " Password should be 8+ characters";
    } elseif (!$avatar['name']) {
        $_SESSION[''] = " please add avatar";
    } else {
