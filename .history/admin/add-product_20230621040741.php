...
<section class="form_section">
    <div class="container form_section_container">
        ...
        <form action="<?= ROOT_URL ?>admin/add-product-logic.php" enctype="multipart/form-data" method="POST">
            ...
            <input type="text" name="description_title" value="<?= $description ?>" placeholder="Description Title" />
            ...
            <input type="text" name="keycap_material" value="<?= $b ?>" placeholder="KeyCap Material" />
