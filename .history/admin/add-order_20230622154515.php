...
$product_no1 = $_SESSION['add--data']['product-no1'] ?? null;
$price1 = $_SESSION['add--data']['price1'] ?? null;
$quantity1 = $_SESSION['add--data']['quantity1'] ?? null;
$product_no2 = $_SESSION['add--data']['product-no1'] ?? null;
$price2 = $_SESSION['add--data']['price1'] ?? null;
$quantity2 = $_SESSION['add--data']['quantity1'] ?? null;
$product_no1 = $_SESSION['add--data']['product-no1'] ?? null;
$price1 = $_SESSION['add--data']['price1'] ?? null;
$quantity3 = $_SESSION['add--data']['quantity1'] ?? null;
$total = $_SESSION['add--data']['email'] ?? null;
