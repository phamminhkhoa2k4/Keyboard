...
if (isset($_POST['submit'])) {
    ...
    $address = filter_var($_POST['a'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    if ($_SESSION['add-order']) {
        ...
        $inset_order_query = "INSERT INTO users SET product_no1='$product_no1',price1='$price',quantity1='$quantity1',product_no2='$product_no2',price2='$price2',quantity2='$quantity2', product_no3='$product_no3',price3='$price3',quantity3='$quantity34',total='$total', username='$username' , phone='$phone' , email='$email', address = '$address'";
