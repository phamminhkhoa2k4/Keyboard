...
$brand = $_SESSION['add--data']['firstname'] ?? null;
$name = $_SESSION['add--data']['lastname'] ?? null;
$price = $_SESSION['add--data']['username'] ?? null;
$description_title = $_SESSION['add--data']['username'] ?? null;
$description = $_SESSION['add--data']['username'] ?? null;
$guarantee = $_SESSION['add--data']['username'] ?? null;
$type = $_SESSION['add--data']['username'] ?? null;
$cable = $_SESSION['add--data']['username'] ?? null;
$switch = $_SESSION['add--data']['username'] ?? null;
$size = $_SESSION['add--data']['username'] ?? null;
$connect_type = $_SESSION['add--data']['username'] ?? null;
$color = $_SESSION['add--data']['username'] ?? null;
$led_color = $_SESSION['add--data']['username'] ?? null;
$keycap_material = $_SESSION['add--data']['username'] ?? null;
