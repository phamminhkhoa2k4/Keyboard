...
if (isset($_POST['submit'])) {
    ...
    if (!$product_no1) {
        ...
        $query = "UPDATE order_product SET product_no1= ? ,price1= ? ,quantity1= ?,product_no2='$product_no2',price2='$price2',quantity2='$quantity2', product_no3='$product_no3',price3='$price3',quantity3='$quantity3',total='$total', username='$username' , phone='$phone' , email='$email', address = '$address' WHERE id = ?";
