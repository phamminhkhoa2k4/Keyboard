    ...
    <div class="container form_section_container">
        ...
        <form action="signup-logic.php" enctype="multipart/form-data" method="POST">
            ...
            <div class="form_control">
                ...
                <input type="file" value="<?= $products['images_no1'] ?>" name="image_no2" id=" " />
            </div>
            <div class="form_control">
                <label for="">Image Product No 3</label>
                <input type="file" value="<?= $products['images_no1'] ?>" name="image_no3" id=" " />
            </div>
            <div class="form_control">
                <label for="">Image Product No 4</label>
                <input type="file" value="<?= $products['images_no1'] ?>" name="image_no4" id=" " />
            </div>
            <div class="form_control">
                <label for="">Image Product No 5</label>
                <input type="file" value="<?= $products['images_no1'] ?>" name="image_no5" id=" " />
            </div>
            <input type="text" value="<?= $products['images_no5'] ?>" placeholder="Description Title" />
            ...
            <input type="text" name="keycap_material" value="<?= $products['images_no1'] ?>" placeholder="KeyCap Material" />
