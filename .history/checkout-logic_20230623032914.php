...
if (isset($_POST['submit'])) {
    ...
    if (!$username) {
        $_SESSION['add-check'] = "Please enter your name";
    } elseif (!$email || !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        $_SESSION['add-check'] = "Please enter a valid email address";
    } elseif (!$phone) {
        $_SESSION['add-check'] = "Please enter your phone number";
    } elseif (!$address) {
        $_SESSION['add-check'] = "Please enter your address";
    } elseif (empty($_SESSION['cart'])) {
        $_SESSION['add-check'] = "Your cart is empty";
    } else {
