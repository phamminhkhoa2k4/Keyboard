        ...
        if (sizeof($_SESSION['cart']) > 0) {
            ...
            for ($i = 0; $i < sizeof($_SESSION['cart']); $i++) {
                ...
                <td class="text-right d-none d-md-block">
                    <a href="cart.php?deleteId=' . $i . '" class="btn btn-light" style="background:var(--color-red)" data-abc="true" onclick="removeCartItem(0)">
                        Remove</a>
                </td>
            </tr>';
            }
            ...
            <div class="alert_message error container " style="text-align: center;margin-top:127px;">
                <p>
                   Giỏ Hàng Đang Trống ! 
                </p>
                ...
                <div class="card">
                    <div class="card-body">
                        <dl class="dlist-align">
                            <dt>Total price:</dt>
                            <dd id="total-price" class="text-right ml-3"><?php echo $totalAll; ?><span>vnd</span></dd>
                        </dl>
                        <dl class="dlist-align">
                            <dt>Discount:</dt>
                        ...
                        <dl class="dlist-align">
                            ...
                            <dd class="text-right text-dark b ml-3" id="final-total">
                                <strong><?php echo $totalAll; ?><span>vnd</span></strong>
                            </dd>
                        </dl>
                        <hr />
                        <a href="checkout.php" class="btn btn-out btn-primary btn-square btn-main" data-abc="true">
                            Make Purchase
                        </a>
