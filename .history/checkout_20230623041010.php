        ...
        <div class="checkout-wrapper">
            <div class="checkout-info">
                <div class="checkout-form">
                    <input type="text" name="username" value="<?= $brand ?>" placeholder="Username">
                    <input type="text" name="phone" value="<?= $brand ?>" placeholder="Phone">
                    <input type="text" name="email" value="<?= $brand ?>" placeholder="Email">
                    <textarea name="address" rows="5" placeholder="Address"><?= $brand ?></textarea>
                </div>
            </div>
            <div class="checkout-order">
                <form method="post" action="<?= ROOT_URL ?>checkout-logic.php">
