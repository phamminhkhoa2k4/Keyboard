...
function showCart()
{
    if (isset($_SESSION['cart']) && (is_array($_SESSION['cart']))) {
        ...
        for ($i = 0; $i < sizeof($_SESSION['cart']); $i++) {
            $total = $_SESSION['cart'][$i][2] * $_SESSION['cart'][$i][5];
            $totalAll += $total;
            echo '<tr>
                         <td>
                             <figure class="itemside align-items-center">
                                 <div class="aside">
                                     <img src="images/' . $_SESSION['cart']['$i'][0] . '" class="img-sm" />
                                 </div>
                                 <figcaption class="info">
                                     <a href="#" class="title text-dark" data-abc="true">' . $_SESSION['cart']['$i'][1] . '</a>
                                     <p class="text-muted small">
                                         SIZE: ' . $_SESSION['cart']['$i'][1] . ' <br />
                                         Brand:' . $_SESSION['cart']['$i'][1] . '
                                     </p>
                                 </figcaption>
                             </figure>
                         </td>
                         <td>
                             <input type="number" value="" min="1" onchange="updateCartItem(0, this.value)">
                         </td>
                         <td>
                             <div class="price-wrap">
                                 <var class="price">' . $_SESSION['cart']['$i'][1] . '</var>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless table-shopping-cart">
                            ...
                            <tbody>
                                ...
                                $totalAll = 0;
                                for($i = 0 ; $i
                                < sizeof($_SESSION['cart']) ; $i++){ $total=$_SESSION['cart'][$i][2] * $_SESSION['cart'][$i][5]; $totalAll +=$total; echo '<tr>
                         <td>
                             <figure class="itemside align-items-center">
                                 <div class="aside">
                                     <img src="images/' .$_SESSION['cart']['$i'][0].'" class="img-sm" />
            ...
            <div class="card">
                <div class="card-body">
                    <dl class="dlist-align">
                        <dt>Total price:</dt>
                        <dd id="total-price" class="text-right ml-3"><?php  echo '$total' ?></dd>
                    </dl>
                    <dl class="dlist-align">
                        <dt>Discount:</dt>
