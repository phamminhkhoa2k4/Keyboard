...
if(isset($_GET['id'])){
    $id = filter_var($_GET['id'],FILTER_SANI)
}
?>
            ...
            <div class="thumbnail_list-wrapper-container">
                <div class="thumbnail_list-wrapper">
                    <div class="thumbnail_list-items">
                        <div class="thumbnail_list-items-list"><a href=""><img src="./images/ban-phim-co-akko-3098s-patrick-1.jpg" alt=""></a></div>
                        <div class="thumbnail_list-items-list"><a href=""><img src="./images/ban-phim-co-akko-3098s-patrick-1.jpg" alt=""></a></div>
                        <div class="thumbnail_list-items-list"><a href=""><img src="./images/ban-phim-co-akko-3098s-patrick-1.jpg" alt=""></a></div>
                        <div class="thumbnail_list-items-list"><a href=""><img src="./images/ban-phim-co-akko-3098s-patrick-1.jpg" alt=""></a></div>
                    </div>
        ...
        <div class="detail_information_container">
            <div class="detail_information_wrapper">
                ...
                <h1 class="detail_information_title">
                    Bàn phím co·AKKO 3098S Patrick (RGB / PBT Dye-subbed / JDA profile / AKKO CS switch)</h1>
                <div class="price_information_wrapper">
                    <p>1.222.000<span>vnd</span></p>
                </div>
